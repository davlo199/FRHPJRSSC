...
#SBATCH --time              24:00:00    # Should be about 120% of the time you estimate needed
#SBATCH --output            Check3000.txt  # What would usually be printed to terminal will go here.
...
matlab -nodisplay -r "ExpConsCheck input_files/testInputSlurmInner"
